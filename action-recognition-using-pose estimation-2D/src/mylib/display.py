...
def drawActionResult(img_display, skeleton, str_action_type):
    ...
    img_display = cv2.rectangle(img_display,(minx, miny),(maxx, maxy),(255,0,0), 2)
    ...
    img_display = cv2.putText(
        img_display, str_action_type, (TEST_COL, TEST_ROW), font, fontsize, (157, 50, 220), linewidth, cv2.LINE_AA)
